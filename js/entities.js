...
class Player extends Entity{ //não tem interface para adicionar KeyBoardListener...
    ...
    update(){
        ...
        Camera.set_x = Camera.border(Math.floor(this.get_x - Game.get_width/2), 0, world.width*Resources._size - Game.get_width);
        Camera.set_y = Camera.border(Math.floor(this.get_y - Game.get_height/2), 0, world.height*Resources._size - Game.get_height);
